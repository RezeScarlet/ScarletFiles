...
if [ "$ans" != "n" ];
then
  yay -Syuq --noconfirm --needed  niri xwayland-satellite wl-mirror wpaperd fuzzel waybar xdg-desktop-portal-gtk xdg-desktop-portal-gnome gnome-keyring plasma-polkit-agent
